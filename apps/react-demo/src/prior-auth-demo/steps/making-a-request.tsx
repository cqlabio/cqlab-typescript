    ...
    "medicationID": "nurtec_1234",
      ...
      <Paper sx={{ padding: '1px 15px 15px 15px', marginTop: '30px' }}>
        ...
        <p>
          ...
          <strong>electronic form</strong> automatically. This is the main
          advantage of creating the authorization rules in a machine readable
          format (as opposed to a text document or PDF).
        </p>

        <p>
          CQLab also provides the ability to greatly increase the efficiency of
          the process by <strong>auto-answering</strong> questions on the form
          using the patient's medical history if it is available from an EHR or
          claims data.
        </p>
        <p>
